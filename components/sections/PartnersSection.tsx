    ...
    <Section id="partners" className="bg-[#070709] border-t border-white/5 overflow-hidden">
      <Container size="lg">
        ...
        <div className="text-center mb-12 space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 text-[10px] font-mono uppercase tracking-widest text-neutral-400">
