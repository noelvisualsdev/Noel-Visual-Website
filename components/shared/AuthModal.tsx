    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
        <motion.div
          ...
          className="relative max-w-[420px] w-full bg-[#0e0e11] border border-[#1f1f24] rounded-2xl p-7 shadow-2xl overflow-hidden"
        >
          {/* Close button */}
          <button
            onClick={onClose}
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-3.5">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl bg-[#151518] border border-[#242429] text-white text-xs placeholder:text-neutral-500 focus:outline-none focus:border-white/40 transition-all"
                />
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3 rounded-xl bg-[#151518] border border-[#242429] text-white text-xs placeholder:text-neutral-500 focus:outline-none focus:border-white/40 transition-all"
                />
                <button
                  type="button"
              ...
              <button
                ...
                className="w-full py-2.5 px-4 rounded-xl bg-[#151518] border border-[#242429] hover:border-white/30 text-white font-medium text-xs flex items-center justify-center gap-2.5 transition-all"
              >
            ...
            <form onSubmit={handleRegister} className="space-y-3">
              ...
              {(linkedDiscord?.id || user?.id) ? (
                ...
                <button
                  ...
                  className="w-full p-2.5 rounded-xl bg-[#151518] border border-[#242429] hover:border-indigo-500/50 text-neutral-300 font-medium text-xs flex items-center justify-between transition-all"
                >
            ...
            <form onSubmit={handleVerifyCode} className="space-y-5">
              <div className="space-y-2">
                <input
                  ...
                  className="w-full text-center text-2xl tracking-[0.5em] font-mono py-3 rounded-xl bg-[#151518] border border-[#242429] text-white focus:outline-none focus:border-white/50"
                />
              </div>
